...
a["Core/Utilities.js"]],function(a,d){var e=a.seriesTypes.sma,g=d.defined,n=d.error,v=d.merge,f;(function(d){function t(b){var h,a=[];b=b||this.points;if(this.fillGraph&&this.nextPoints){if((h=e.prototype.getGraphPath.call(this,this.nextPoints))&&h.length){h[0][0]="L";a=e.prototype.getGraphPath.call(this,b);h=h.slice(0,a.length);for(var c=h.length-1;0<=c;c--)a.push(h[c])}}else a=e.prototype.getGraphPath.apply(this,arguments);return a}function p(){var b=this,h=b.linesApiNames,c=b.areaLinesNames,d=
b.points,p=b.options,u=b.graph,t={options:{gapSize:p.gapSize}},f=[],m=b.getTranslatedLinesNames(b.pointValKey),r=d.length,q;m.forEach(function(b,c){for(f[c]=[];r--;)q=d[r],f[c].push({x:q.x,plotX:q.plotX,plotY:q[b],isNull:!g(q[b])});r=d.length});if(this.userOptions.fillColor&&c.length){var l=m.indexOf(k(c[0]));l=f[l];c=1===c.length?d:f[m.indexOf(k(c[1]))];m=b.color;b.points=c;b.nextPoints=l;b.color=this.userOptions.fillColor;b.options=v(d,t);b.graph=b.area;b.fillGraph=!0;a.seriesTypes.sma.prototype.drawGraph.call(b);
b.area=b.graph;delete b.nextPoints;delete b.fillGraph;b.color=m}h.forEach(function(c,a){f[a]?(b.points=f[a],p[c]?b.options=v(p[c].styles,t):n('Error: "There is no '+c+' in DOCS options declared. Check if linesApiNames are consistent with your DOCS line names." at mixin/multiple-line.js:34'),b.graph=b["graph"+c],e.prototype.drawGraph.call(b),b["graph"+c]=b.graph):n('Error: "'+c+" doesn't have equivalent in pointArrayMap. To many elements in linesApiNames relative to pointArrayMap.\"")});b.points=d;
b.options=p;b.graph=u;e.prototype.drawGraph.call(b)}function c(b){var c=[];(this.pointArrayMap||[]).forEach(function(a){a!==b&&c.push(k(a))});return c}function k(b){return"plot"+b.charAt(0).toUpperCase()+b.slice(1)}function u(b){var c=[];(this.pointArrayMap||[]).forEach(function(a){c.push(b[a])});return c}function m(){var b=this,c=b.pointArrayMap,a=[],d;a=b.getTranslatedLinesNames();e.prototype.translate.apply(b,arguments);b.points.forEach(function(h){c.forEach(function(c,k){d=h[c];b.dataModify&&
(d=b.dataModify.modifyValue(d));null!==d&&(h[a[k]]=b.yAxis.toPixels(d,!0))})})}var f=[],r=["bottomLine"],x=["top","bottom"],l=["top"];d.compose=function(b){if(-1===f.indexOf(b)){f.push(b);var a=b.prototype;a.linesApiNames=a.linesApiNames||r.slice();a.pointArrayMap=a.pointArrayMap||x.slice();a.pointValKey=a.pointValKey||"top";a.areaLinesNames=a.areaLinesNames||l.slice();a.drawGraph=p;a.getGraphPath=t;a.toYData=u;a.translate=m;a.getTranslatedLinesNames=c}return b}})(f||(f={}));return f});g(a,"Stock/Indicators/AroonOscillator/AroonOscillatorIndicator.js",
